...
import sys, json, re, datetime, argparse
import numpy as np
from pathlib import Path

HERE         = Path(__file__).parent
_DEFAULT_CAL = HERE.parent / "output" / "calibration_result.json"
...
if __name__ == "__main__":
    ...
    ap.add_argument("folder", help="Folder with ABT txt files and raw videos")
